...
class ADCS:
  ...
  def compute(self, t: float, gps: np.ndarray,
    ...
    #Assign names to the number of degrees between Earth Magnetic field, camera, and target ideal
    EarthCamera = thetaError(magGlobal, rCameraGlobal)
