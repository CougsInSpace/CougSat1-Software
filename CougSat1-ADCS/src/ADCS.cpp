...
ADCS::ADCS(float dtInit) : cdh(TEST_IHU_ADDRESS, BUS_I2C0_SDA, BUS_I2C0_SCL), sensorBus(D14,D15), imu(sensorBus,NC,(0X28<<1)), hBridgeCoilX(COIL_X_FWD, COIL_X_REV, COIL_X_SLEEP_N) {
  this->dt = dtInit;
