...
#define CLOCK_SOURCE                                                      USE_PLL_HSE_XTAL                        // set by target:CIS_BOARD
#define LPTICKER_DELAY_TICKS                                              4                                       // set by target:CIS_BOARD
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                   1                                       // set by target:CIS_BOARD
