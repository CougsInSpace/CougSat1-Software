...
#include "configurations/OV5642.h"
 ...
 * @return error code
 */
uint8_t ArduCAM::readFifo(uint8_t *buf, uint8_t burstLength) {
  spi.lock();
  select = 0;
 ...
 * @return error code
 */
uint8_t ArduCAM::setResolution(uint8_t size) {
  uint8_t result = writeRegList(OV5642_1280x960_RAW);
  result |= writeRegList(OV5642_640x480_RAW);
 ...
 * @return error code
 */
uint8_t ArduCAM::setFormat(uint8_t format) {
 ...
 * @return error code
 */
uint8_t ArduCAM::readReg(uint16_t addr, uint8_t *data) {
  uint8_t result;
  char buf[2] =
 ...
 * @return error code
 */
uint8_t ArduCAM::readReg16(uint16_t addr, uint16_t *data) {
  uint8_t buf[2] =
  { 0, 0 };
 ...
 * @return error code
 */
uint8_t ArduCAM::writeReg(uint16_t addr, uint8_t data) {
  uint8_t result;
  char buf[3] =
 ...
 * @return error code
 */
uint8_t ArduCAM::writeReg16(uint16_t addr, uint16_t data) {
