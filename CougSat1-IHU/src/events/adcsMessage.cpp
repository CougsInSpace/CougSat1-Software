 ...
 ******************************************************************************/
/**
 * @file adcsMessage.cpp
 * @author Bradley Davis
 * @date 6 Mar 2018
 * @brief sends a message to the ADCS via the ADCS system interface
 *
 * dataBlock structure:
...
void adcsMessage(uint8_t *dataBlock, uint16_t dataLength){
  ...
  //Perfrom action
  //If ADCS has data to return, add event "sendToGround"
}
