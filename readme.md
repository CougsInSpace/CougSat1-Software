...
2.  Go into the cougsat1-software file and click on the .githooks folder copy the precommit file.
3. go back and then click on the .git file then click on the hooks folder then paste the file in there.
* Open the folder to the target processor. Save this as a workspace if you want, you can then add the library folder to see those files too. You can do this by clicking file/open folder. In file explorer make sure your are in Cougsat1-software then click on project you are working on.
