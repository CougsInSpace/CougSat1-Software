...
public class Telemetry extends DownlinkPacket {
	...
	public boolean decodePacket(File file, CougSat satellite) throws IOException {
		...
		satellite.setRoll(FileUtils.readNextBytes(inFile, 2));
		satellite.setPitch(FileUtils.readNextBytes(inFile, 2));
		satellite.setYaw(FileUtils.readNextBytes(inFile, 2));
		...
		satellite.setXCurrent((int) FileUtils.readNextBytes(inFile, 2));
		satellite.setYCurrent((int) FileUtils.readNextBytes(inFile, 2));
		satellite.setZCurrent((int) FileUtils.readNextBytes(inFile, 2));
