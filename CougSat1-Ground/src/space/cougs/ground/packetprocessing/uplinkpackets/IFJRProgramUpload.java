...
public class IFJRProgramUpload extends UplinkPacket {
	...
	public File encodePacket() throws IOException {
		...
		// // First packet
		// int serialNumber = 0;
		// FileOutputStream outStream = new FileOutputStream(new File(folderPath
		// + serialNumber));
		...
		// long packetLength = Math.min(getMaxPacketLength(), programLength +
		// headerLength);
