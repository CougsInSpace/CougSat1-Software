...
/******************************** Power Nodes *********************************/
PowerNode nodesPVIn[8] = {PowerNode(adcPV0, PIN_ADC_PVIN_I_A, SHUNT_PVIN_0A),
...
PowerNode nodesPRBatt[7] = {PowerNodeDirect(adcEPS1, PIN_ADC_PR_BATT_0,
                               SHUNT_PR_BATT_0, PIN_PC_BATT_0A, PIN_PC_BATT_0B),
...
PowerNode nodesBatteryHeaters[2] = {
